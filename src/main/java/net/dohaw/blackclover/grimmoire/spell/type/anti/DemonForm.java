...
public class DemonForm extends CastSpellWrapper {
    ...
    public boolean cast(Event e, PlayerData pd) {
        ...
        BukkitTask tornadoParticleRunner = new TornadoParticleRunner(player, new Particle.DustOptions(BukkitColor.darkGrey, 1), true, 1, false).runTaskTimer(Grimmoire.instance, 0L, 1L);
        ...
        CircleParticleRunner circleParticleRunner = new CircleParticleRunner(player, new Particle.DustOptions(BukkitColor.darkGrey, 1), true, 1);
